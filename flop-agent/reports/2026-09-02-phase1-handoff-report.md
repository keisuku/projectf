...
> **§3 の本文案 A / B / C は 2026-09-03 に撤回済み。書かないこと。**
> B は `flop-labs/tclk at 81a8346` と書いているが、tclk は 2026-09-03 に `1459b78` へ動いた。
> 承認済みの本文と SHA-256 は `reports/2026-09-03-approved-maintenance-body.md`。
> この文書は Phase 1 時点の記録として残す。
